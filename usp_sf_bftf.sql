if exists(select * from sysobjects where name='usp_sf_bftf')
	drop proc usp_sf_bftf
go
...
as --集190125 2017-03-06 11:22:06 4.0标准版
/**********
[版本号]4.0.0.0.0
[创建时间]2004.11.3
[作者]王奕
...
begin
	...
	select xh, cfxh, cd_idm, gg_idm, dxmdm,	ypmc, ypdm, ypgg, ypdw, dwxs, ykxs,
     ...
     ,qrczyh,qrksdm,ssbfybz   -- add by sqf 20110323
		,zje,tmxxh,shbz,yqrsl,ktsl,wsbz,ldcfxh,ldmxxh,tfbz
	...
	select xh, cfxh, cd_idm, gg_idm, dxmdm,	ypmc, ypdm, ypgg, ypdw, dwxs, ykxs,
		...
		, lcxmdm, lcxmmc,lcxmsl,dydm,yjqrbz,zbz,lcjsdj,yjspbz --add "dydm" 20070119
        ,qrczyh,qrksdm,ssbfybz,zje,tmxxh,shbz,yqrsl,ktsl,isnull(wsbz,0),ldcfxh,ldmxxh,tfbz 
...
----------------- 
	...
	begin
		...
		select a.sjh, a.patid, a.ghsjh, a.ghxh, a.fph, a.fpjxh, a.czyh, a.sfrq, a.sfksdm, a.ksdm, a.hzxm, a.blh, a.ybdm, a.pzh, 
			...
			,a.yhdm,a.appjkdm --add by yjn 2015-03-21
...
*/
	...
	begin
		...
		begin
			...
			select @xhtemp, cd_idm, gg_idm, dxmdm, ypmc, ypdm, ypdw, dwxs, ykxs, ypfj, ylsj, 
				...
				lcjsdj,yjspbz,qrczyh,qrksdm,ssbfybz,isnull(round(ypsl*ylsj*cfts/ykxs,2),0),xh,shbz,yqrsl,case @config2471 when 0 then ktsl else 0 end,isnull(wsbz,0),ldcfxh,ldmxxh  --add "dydm" 20070119	--add fpzh by ozb 20060622 增加发票组号
				,case when @config2471=0 and ktsl > 0 then 1 else 0 end
	...
	begin
		...
		insert into SF_BRJSMXK(jssjh, dxmdm, dxmmc, fpxmdm, fpxmmc, xmje, zfje, zfyje, yhje, memo, flzfje
			,tsyhje, gbzfje,gbfwje,gbfwwje,gbtsfwje,gbtsfwwje,gbtszfje ,lcyhje)
