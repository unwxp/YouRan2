if exists(select 1 from sysobjects where name='usp_sf_sfcl')
	drop proc usp_sf_sfcl
go
create proc usp_sf_sfcl
	@wkdz varchar(32),
	@jszt smallint,
	@sfbz smallint,
	@sflb smallint,
	...
	begin
		...
		begin
			...
			select @pkdj =pkdj from SF_BRXXK a(nolock),YY_PKRKXXB b(nolock) where a.patid =@patid and a.sfzh =b.sfzh
			 ...
			 where b.idm=a.idm and b.xmdm=a.xxmdm and b.pkdj=@pkdj    
		end
		--扶贫政策改造 end
